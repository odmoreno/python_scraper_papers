...
patterns = {
    ...
    "InfoVis": re.compile(r"\b(InfoVis|IEEE InfoVis| Information Visualization |IEEE Symposium on Information Visualization)\b",re.IGNORECASE),
    ...
    'TVCG': re.compile(r'\b(TVCG|Transaction on Computer Graphics|IEEE Transactions on Visualization and Computer Graphics|Visualization and Computer Graphics)\b', re.IGNORECASE),
    ...
    'IEEE TVCG2': re.compile(r'\b(IEEE\sTransactions\s?on\sComputer\s?Graphics\s?and\s?Visualization)\b',re.IGNORECASE),
    ...
    "AutoSciEng": re.compile(r"IEEE Transactions on Automation Science and Engineering", re.IGNORECASE),
    'Proceedings of Graphics Interface': re.compile(r'(Proceedings of Graphics Interface|Graphics Interface)', re.IGNORECASE),
    'CG&A': re.compile(r'CG&A|Computer Graphics and Applications', re.IGNORECASE),
    'TOG': re.compile(r'TOG|ACM Transactions on Graphics', re.IGNORECASE),
    'ISMAR': re.compile(r'ISMAR|International Symposium on Mixed and Augmented Reality', re.IGNORECASE),
    'ICIP': re.compile(r'ICIP|IEEE International Conference on Image Processing', re.IGNORECASE),
    'ITS': re.compile(r'ITS|ACM Conference on Interactive Tabletops and Surfaces', re.IGNORECASE),
    'GI': re.compile(r'GI|Graphics Interface', re.IGNORECASE),
    'WSCG': re.compile(r'WSCG|International Conference on Computer Graphics, Visualization and Computer Vision', re.IGNORECASE),
    'PCS': re.compile(r'PCS|Pacific Conference on Computer Graphics and Applications', re.IGNORECASE),
    'PG': re.compile(r'PG|Practical Graphics', re.IGNORECASE),
